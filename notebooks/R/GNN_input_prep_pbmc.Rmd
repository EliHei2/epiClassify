...
gene_names_f = file.path(data_input, 'gene_names.txt')
### output
...
meta_sub_1 = cell_meta_1  %>%
    .[, .SD[sample(1:dim(.SD)[1], min(min_cells, ..cmp_pbmc1[cell_type]))], by = 'cell_type']
...
colnames(data_pbmc1) %>% write(gene_names_f)
```